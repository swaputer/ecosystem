...
const builtinApps: ReadonlyArray<EcosystemApp> = [
  { id: "browser", name: "Explore", domain: "scan.swaputer.com", category: "Explore", status: "approved", external: true },
  { id: "mint", name: "Factory", domain: "swaputer.com", description: "Create and mint tokens on Swaputer.", category: "Tools", path: "/factory", external: false, appId: "mint", status: "approved" },
  { id: "wallet", name: "Wallet", domain: "swaputer.com", description: "Manage and transfer Swaputer assets.", category: "Wallet", path: "/wallet", external: false, appId: "wallet", status: "approved" },
