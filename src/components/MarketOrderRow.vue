...
<template>
  <div class="market-order-row" role="row">
    ...
    <div class="order-maker" role="cell"><a :href="explorerURL(`/address/${order.maker}`)" target="_blank" rel="noopener noreferrer" :title="order.maker"><span class="sr-only">Maker </span>{{ shortHex(order.maker, 8, 6) }}</a></div>
