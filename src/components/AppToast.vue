...
.toast { min-height: 48px; padding: 10px 10px 10px 12px; border: 1px solid var(--rule-strong); border-radius: 2px; background: var(--surface); box-shadow: 3px 3px 0 rgba(48, 59, 65, .3); display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: 9px; color: var(--ink); pointer-events: auto; }
.toast > p { margin: 0; font-size: var(--text-sm); line-height: 1.4; }
.toast > button { width: 44px; height: 44px; border: 0; border-radius: 6px; background: transparent; color: var(--muted); display: grid; place-items: center; }
