...
const preferredWidth: Record<AppId, number> = { mint: 860, wallet: 940, browser: 800, studio: 960 };
const preferredHeight: Record<AppId, number> = { mint: 650, wallet: 650, browser: 620, studio: 650 };
const desktopTop = 48;
